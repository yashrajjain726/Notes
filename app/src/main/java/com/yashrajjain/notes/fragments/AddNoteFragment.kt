...
import com.yashrajjain.notes.databinding.FragmentAddNoteBinding
import com.yashrajjain.notes.model.Note
import com.yashrajjain.notes.viewmodel.NoteViewModel

class AddNoteFragment : Fragment(R.layout.fragment_add_note), MenuProvider {
    private var dataBinding: FragmentAddNoteBinding?=null
    ...
    override fun onCreateView(
        ...
        dataBinding = FragmentAddNoteBinding.inflate(inflater,container,false)
        return binding.root
    }
    ...
    fun saveNote(view:View){
        ...
        if(noteTitle.isNotEmpty()){
            ...
            Toast.makeText(addNoteView.context, "Note title is required, Please enter Note Title !", Toast.LENGTH_SHORT).show()
        }
    }
